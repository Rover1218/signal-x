    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 py-8">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-20 right-10 w-72 h-72 bg-purple-600/20 rounded-full blur-3xl animate-float" />
                <div className="absolute bottom-20 left-20 w-96 h-96 bg-cyan-500/15 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }} />
            </div>
            ...
            <div className="glass-card p-10 md:p-12 w-full max-w-lg relative z-10">
                ...
                <h1 className="text-2xl md:text-3xl font-bold text-center mb-3 text-white">Create Account</h1>
                <p className="text-gray-400 text-center mb-10 text-base">Join SignalX to make an impact</p>
