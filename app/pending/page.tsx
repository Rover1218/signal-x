    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
            ...
            <div className="glass-card p-10 max-w-lg text-center relative z-10">
                <div className="w-20 h-20 bg-gradient-to-br from-amber-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-6 animate-pulse-glow">
                ...
                <h1 className="text-3xl font-bold mb-4">
                    <span className="gradient-text">Pending Approval</span>
                </h1>
